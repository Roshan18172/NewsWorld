...
export class News extends Component {
    ...
    async componentDidMount() {
        ...
        let url= "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=46efa12190ad4529ac392f8a69578a01&page=1&pageSize=20";
    ...
    handlePrevClick = async () => {
        ...
        let url= `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=46efa12190ad4529ac392f8a69578a01&page=${this.state.page - 1}&pageSize=20`;
        let data = await fetch(url);
        let parsedData = await data.json();
        this.setState({
    ...
    return (
      <div className="container-fluid ">
        ...
        <div className="container d-flex justify-content-between my-3">
            ...
            <p className="text-center m-auto">Page {this.state.page} of {Math.ceil(this.state.totalResults / 20)}</p>
