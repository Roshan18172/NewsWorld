...
export class News extends Component {
    ...
    async updateOnRequest() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=a9185dcd058c4b849a9fba190478b879&page=${this.state.page}&pageSize=${this.props.pageSize}`;
