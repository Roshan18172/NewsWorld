...
export class News extends Component {
    ...
    async updateOnRequest() {
        ...
        // 1. Reconstruct the clean, absolute NewsAPI endpoint
        const targetUrl = ` https://gnews.io/api/v4/top-headlines?category=${this.props.category}&apiKey=${this.props.apiKey}`;

        // 2. Safely proxy the well-formed URL
            ...
            <div className="container-fluid ">
                ...
                <div className="container m-auto row bg-warning " style={{ marginBottom: "160px" }}>
                    {!this.state.loading && this.state.articles?.map((element) => {
                        return <div className="col-12 col-sm-6 col-md-4 col-lg-3 my-4" key={element.title || element.url}>
                ...
                <div className="container d-flex justify-content-between my-3 fixed-bottom bg-success ">
                    ...
                    <p className="text-center m-auto">Page {this.state.page} of {Math.ceil(this.state.totalResults / this.props.pageSize) || 1}</p>
